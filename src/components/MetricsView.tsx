...
const chartConfigs = [
  ...
  },
  {
    ...
    metrics: [
      {
        key: 'http.downloaded_bytes',
        label: 'http.downloaded_bytes',
        isFilled: true,
      },
    ],
  },
  ...
  },
  {
    ...
    metrics: [
      {
        key: 'plugins.metrics-by-endpoint./transaction.codes.201',
        label: 'plugins.metrics-by-endpoint./transaction.codes.201',
      },
    ],
  },
  {
    ...
    metrics: [
      {
        key: 'plugins.metrics-by-endpoint./transaction.errors.ETIMEDOUT',
        label: 'plugins.metrics-by-endpoint./transaction.errors.ETIMEDOUT',
      },
    ],
  },
  {
    ...
    metrics: [
      {
        key: 'plugins.metrics-by-endpoint.response_time./transaction.min',
        label: 'min',
      },
      {
        key: 'plugins.metrics-by-endpoint.response_time./transaction.mean',
        label: 'mean',
      },
      {
        key: 'plugins.metrics-by-endpoint.response_time./transaction.p50',
        label: 'p50',
      },
      {
        key: 'plugins.metrics-by-endpoint.response_time./transaction.p95',
        label: 'p95',
      },
      {
        key: 'plugins.metrics-by-endpoint.response_time./transaction.p99',
        label: 'p99',
      },
      {
        key: 'plugins.metrics-by-endpoint.response_time./transaction.max',
        label: 'max',
      },
    ],
  },
  {
    ...
    metrics: [
      ...
      {
        key: 'vusers.created_by_name.Load Test',
        label: 'vusers.created_by_name.Load Test',
        isFilled: true,
      },
    ],
  },
...
function MetricsView({ data }: MetricsViewProps) {
          ...
          <Card key={config.title} id={`chart-${sanitizedTitle(config.title)}`}>
            <CardContent>
              <MetricChart
                ...
                yAxisType={
                  config.yAxisType as 'time' | 'count' | 'bytes' | undefined
                }
